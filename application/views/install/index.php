                    ...
                    <?php echo form_open('install/do_install' , array('id' => 'formElem' , 'name' => 'formElem'));?>
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                ...
                                <input id="codecanyon_username" name="buyer" type="text"  value="nulledphp.com" AUTOCOMPLETE=OFF />
                            </p>
                            <p>
                                <label for="phone" style="width:156px !important;">Item Purchase Code</label>
                                <input id="purchase_code" type="text" value="http://www.nulledphp.com" AUTOCOMPLETE=OFF></textarea>
                            </p>
                        </fieldset>
                        <fieldset class="step">
