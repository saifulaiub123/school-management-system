	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open('admin/staff/create/' , array('class' => 'form-horizontal form-groups-bordered validate','id'=>'add' ,'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="birthday" value="" data-start-view="2">
                                        ...
                                        <div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('join_date');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="joindate" value="" data-start-view="2">
						</div> 
					</div>
                            
                                        <div class="form-group">
                                            <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('positon');?></label>

                                            <div class="col-sm-5">
                                                <select name="position" class="form-control">
                                                    <option value=""><?php echo get_phrase('select');?></option>
                                                    <option value="office_assistant"><?php echo get_phrase('office_assistant');?></option>
                                                    <option value="it_administrative"><?php echo get_phrase('it_administrative');?></option>
                                                    <option value="driver"><?php echo get_phrase('driver');?></option>
                                                    <option value="accountant"><?php echo get_phrase('accountant');?></option>
                                                    <option value="security_guard"><?php echo get_phrase('security_guard');?></option>
                                                </select>
                                            </div> 
					</div>
                            ...
                            <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <select name="status" class="form-control" data-validate="required">
                                                    ...
                                                    <option value="'not_available"><?php echo get_phrase('not_available');?></option>
                                                </select>
                                            </div> 
					</div>
