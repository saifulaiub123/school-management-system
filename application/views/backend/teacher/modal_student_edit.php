<?php 
$edit_data = $this->db->get_where('student' , array('student_id' => $param1) )->result_array();
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="roll" value="<?php echo $row['roll'];?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php $subject = $this->db->get_where('subject' , array('class_id'=>$row['class_id'],'dep_id'=>$row['dep_id'],'sec_id'=>$row['sec_id']))->result_array(); ?>
                                                ...
                                                <div class="col-sm-5">
                                                    <select name="" class="form-control">
                                                        ...
                                                        <?php foreach($subject as $row1): ?>
                                                            <option value="<?php echo $row1['subject_id'];?>" <?php if($row1['subject_id'] == $row['optional_sub_id'])echo 'selected';?> >
                                                                <?php echo $row1['name'];?> 
                                                            </option>
                                                        <?php endforeach;  ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <select name="status" class="form-control">
                                                    ...
                                                    <option value="<?php echo get_phrase('not_available');?>" <?php if($row['status'] == get_phrase("not_available"))echo 'selected';?>><?php echo get_phrase('not_available');?></option>
                                                </select>
                                            </div> 
					</div>
