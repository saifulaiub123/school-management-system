<div class="sidebar-menu">
		...
		<ul id="main-menu" class="">
			...
			<!-- class "auto-inherit-active-class" will automatically add "active" class for parents elements who are marked already with class "active" -->
           ...
           <li class="<?php if($page_name == 'class')//echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?parents/classes">
           ...
           <li class="<?php if($page_name == 'section' || 
				...
				<ul>
					...
					<!--<li class="<?php if($page_name == 'section_add')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/add_section">
							<span>
					...
					<li class="<?php if($page_name == 'section_information')//echo 'opened active';?> ">
						<a href="#">
							...
							<li class="<?php if ($page_name == 'section_information' && $class_id == $row['class_id']) //echo 'active';?>">
								<a href="<?php echo base_url();?>index.php?parents/section_information/<?php echo $row['class_id'];?>/student_information">
				...
				<ul>
					...
					<!--<li class="<?php if($page_name == 'student_add')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/student_add">
							<span>
                                                            <!--<i class="entypo-dot"></i>--> 
...
<!--					<li class="<?php if($page_name == 'student_add')//echo 'active';?> ">
                  ...
                  <!-- STUDENT INFORMATION -->
					<li class="<?php if($page_name == 'student_information')//echo 'opened active';
                                        ?> ">
						<a href="<?php echo base_url();?>index.php?parents/class_filter/get_student_list/student_list/student_information">
							<span>
                                                            <i class="entypo-dot"></i>
...
<!--                                            <ul>
                  ...
                  <!-- STUDENT MARKSHEET -->
					<li class="<?php if($page_name == 'student_marksheet')//echo 'opened active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/class_filter/student_marksheet/get_marksheet/student_marksheet">
							<span>
                                                            <i class="entypo-dot"></i>
...
<!--                        <ul>
							...
							<li class="<?php if ($page_name == 'student_marksheet' && $class_id == $row['class_id']) //echo 'active';?>">
								<a href="<?php echo base_url();?>index.php?parents/student_marksheet/<?php echo $row['class_id'];?>">
									<span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
								</a>
							</li>
                            <?php endforeach;?>
           ...
           <li class="<?php if($page_name == 'teacher' )//echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?parents/teacher">
           ...
           <li class="<?php if($page_name == 'parents')//echo 'opened active';?> ">
				<a href="<?php echo base_url();?>index.php?parents/class_filter/parents_list/parents_list/get_parents_info">
...
<!--                <ul>
					<?php $classes	=	$this->db->get('class')->result_array();
                    foreach ($classes as $row):?>
                    <li class="<?php if ($page_name == 'parents' && $class_id == $row['class_id'])// echo 'active';?>">
                        <a href="<?php echo base_url();?>index.php?parents/parents/<?php echo $row['class_id'];?>"> 
                        <a href="<?php echo base_url();?>index.php?parents/section_information/<?php echo $row['class_id'];?>/get_parents_info">
                            <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
                        </a>
                    </li>
                    <?php endforeach;?>
           ...
           <li class="<?php if($page_name == 'staff' )//echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?parents/staff">
					<i class="entypo-users"></i>
          ...
          <li class="<?php if($page_name == 'subject')//echo 'opened active';?> ">
              ...
              <ul>
                  ...
                  <li class="<?php if($page_name == 'subject_add')echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/subject_add">
							<span>
                                                            <i class="entypo-dot"></i>
							...
							<span>
                                            ...
                                            <ul>
                                                ...
                                                <li class="<?php if ($page_name == 'subject' && $class_id == $row['class_id']) //echo 'active';?>">
                                                    <!--<a href="<?php echo base_url();?>index.php?parents/subject/<?php echo $row['class_id'];?>">-->

                                                     <a href="<?php echo base_url();?>index.php?parents/subject/<?php echo $row['class_id'];?>/subject">
                                                        <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
                                                    </a>
                                                </li>
                                                <?php endforeach;?>
           ...
           <li class="<?php if($page_name == 'class_routine')//echo 'active';?> ">
               ...
               <ul>
                	<!-- Add Section -->
					<!--<li class="<?php if($page_name == 'section_add')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/add_cl">
							<span>
                                                            <i class="entypo-dot"></i>
                                        ...
                                        <li class="<?php if($page_name == 'section_information')//echo 'opened active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/class_filter/class_routine/show_routine/get_routine_info">
							<span>
                                                            <i class="entypo-dot"></i>
...
<!--                                            <ul>
							...
							foreach ($classes as $row):?>
							<li class="<?php if ($page_name == 'section_information' && $class_id == $row['class_id']) //echo 'active';?>">
								<a href="<?php echo base_url();?>index.php?parents/section_information/<?php echo $row['class_id'];?>/get_routine_info">
                                                                    <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
								</a>
							</li>
                                                <?php endforeach;?>
...
<!--               <ul>
                    ...
                    <li class="<?php if ($page_name == 'parents' && $class_id == $row['class_id']) //echo 'active';?>">
                        <a href="<?php echo base_url();?>index.php?parents/parents/<?php echo $row['class_id'];?>"> 
                        <a href="<?php echo base_url();?>index.php?parents/section_information/<?php echo $row['class_id'];?>/get_attendence_info">
                            <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
                        </a>
                    </li>
                    <?php endforeach;?>
         ...
         <li class="<?php if($page_name == 'exam' || $page_name == 'grade' || $page_name == 'marks')//echo 'opened active';?> ">
                ...
                <ul>
					<li class="<?php if($page_name == 'exam')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/exam">
							<span>
					...
					<li class="<?php if($page_name == 'grade')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/grade">
							<span>
           ...
           <li class="<?php if($page_name == 'invoice')//echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?parents/class_filter/get_invoice_list_list/invoice_list/invoice">
               ...
               <ul>
					...
					<li class="<?php if($page_name == 'grade')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/navigation/add_payment">
							<span>
                                        ...
                                        <li class="<?php if($page_name == 'exam')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/class_filter/get_invoice_list_list/payment_list/invoice">
							<span>
      ...
      <li class="<?php if ($page_name == 'message')// echo 'active'; ?> ">
           ...
           <li class="<?php if($page_name == 'system_settings' || $page_name == 'manage_language')echo 'opened active';?> ">
			...
			<li class="<?php if($page_name == 'system_settings')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/system_settings">
							<span>
                                                            <i class="entypo-dot"></i>
					...
					<!--<li class="<?php if($page_name == 'manage_language')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?parents/manage_language">
							<span>
                                                            <i class="entypo-dot"></i>
