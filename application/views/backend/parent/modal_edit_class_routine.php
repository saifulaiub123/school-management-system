<?php 
$edit_data		=	$this->db->get_where('class_routine' , array('class_routine_id' => $param1) )->result_array();
?>
        ...
        <?php echo form_open('admin/class_routine/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                ...
                <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="teacher_id" class="form-control" style="width:100%;">
										...
										?>
                                    		<option value="<?php echo $row1['teacher_id'];?>"<?php if($row1['teacher_id'] == $row['teacher_id'])echo 'selected';?> ><?php echo $row1['name'];?></option>
                                        <?php
						endforeach;
                                                ?>
                                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <select name="time_start_min" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                                          
                                            <option value="">Minute</option>
                                                <?php for($i = 0; $i <= 60 ; $i++):?>
                                            <option value="<?php echo $i;?>" <?php if($i ==$row['time_start_min'])echo 'selected';?>><?php echo $i;?></option>
                                                <?php endfor;?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <select name="time_end_min" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>">
                                          
                                            <option value="">Minute</option>
                                                <?php for($i = 0; $i <= 59 ; $i++):?>
                                            <option value="<?php echo $i;?>" <?php if($i ==$row['time_end_min'])echo 'selected="selected"';?> ><?php echo $i;?></option>
                                                <?php endfor;?>
                        </select>
