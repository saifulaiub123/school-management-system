           ...
           <li class="<?php if($page_name == 'section' || 
				...
				<ul>
					...
					<li class="<?php if($page_name == 'section_add')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/add_section">
							<span>
					...
					<li class="<?php if($page_name == 'section_information')//echo 'opened active';?> ">
						<a href="#">
							...
							<li class="<?php if ($page_name == 'section_information' && $class_id == $row['class_id']) //echo 'active';?>">
								<a href="<?php echo base_url();?>index.php?admin/section_information/<?php echo $row['class_id'];?>/student_information">
...
<!--                                            <ul>
                  ...
                  <!-- STUDENT MARKSHEET -->
					<li class="<?php if($page_name == 'student_marksheet')//echo 'opened active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/class_filter/student_marksheet/get_marksheet/student_marksheet">
							<span>
                                                            <i class="entypo-dot"></i>
...
<!--                        <ul>
           ...
           <li class="<?php if($page_name == 'parent')//echo 'opened active';?> ">
				<a href="<?php echo base_url();?>index.php?admin/class_filter/parent_list/parent_list/get_parent_info">
...
<!--                <ul>
                    ...
                    <li class="<?php if ($page_name == 'parent' && $class_id == $row['class_id'])// echo 'active';?>">
                        ...
                        <a href="<?php echo base_url();?>index.php?admin/section_information/<?php echo $row['class_id'];?>/get_parent_info">
                            <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
                        </a>
                    </li>
                    <?php endforeach;?>
          ...
          <li class="<?php if($page_name == 'subject')//echo 'opened active';?> ">
              ...
              <ul>
                  ...
                  <li class="<?php if($page_name == 'subject_add')echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/subject_add">
							<span>
                                                            <i class="entypo-dot"></i>
                                            ...
                                            <ul>
                                                ...
                                                <li class="<?php if ($page_name == 'subject' && $class_id == $row['class_id']) //echo 'active';?>">
                                                    <!--<a href="<?php echo base_url();?>index.php?admin/subject/<?php echo $row['class_id'];?>">-->
                                                     ...
                                                     <a href="<?php echo base_url();?>index.php?admin/subject/<?php echo $row['class_id'];?>/subject">
                                                        <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
                                                    </a>
                                                </li>
                                                <?php endforeach;?>
           ...
           <li class="<?php if($page_name == 'class_routine')//echo 'active';?> ">
               ...
               <ul>
                	<!-- Add Section -->
					<li class="<?php if($page_name == 'section_add')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/add_cl">
							<span>
                                                            <i class="entypo-dot"></i>
...
<!--                                            <ul>
							...
							foreach ($classes as $row):?>
							<li class="<?php if ($page_name == 'section_information' && $class_id == $row['class_id']) //echo 'active';?>">
								<a href="<?php echo base_url();?>index.php?admin/section_information/<?php echo $row['class_id'];?>/get_routine_info">
                                                                    <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
								</a>
							</li>
                                                <?php endforeach;?>
...
<!--               <ul>
                    ...
                    <li class="<?php if ($page_name == 'parent' && $class_id == $row['class_id']) //echo 'active';?>">
                        <a href="<?php echo base_url();?>index.php?admin/parent/<?php echo $row['class_id'];?>"> 
                        <a href="<?php echo base_url();?>index.php?admin/section_information/<?php echo $row['class_id'];?>/get_attendence_info">
                            <span><?php echo get_phrase('class');?> <?php echo $row['name'];?></span>
                        </a>
                    </li>
                    <?php endforeach;?>
         ...
         <li class="<?php if($page_name == 'exam' || $page_name == 'grade' || $page_name == 'marks')//echo 'opened active';?> ">
           ...
           <li class="<?php if($page_name == 'invoice')//echo 'active';?> ">
				<a href="<?php echo base_url();?>index.php?admin/class_filter/get_invoice_list_list/invoice_list/invoice">
               ...
               <ul>
					...
					<li class="<?php if($page_name == 'grade')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/navigation/add_payment">
							<span>
                                        ...
                                        <li class="<?php if($page_name == 'exam')//echo 'active';?> ">
						<a href="<?php echo base_url();?>index.php?admin/class_filter/get_invoice_list_list/payment_list/invoice">
							<span>
