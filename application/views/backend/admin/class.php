...
<!--                            <div class="btn-group">
                                ...
                                <!--<ul class="dropdown-menu dropdown-default pull-right" role="menu">-->
                                    ...
                                    <!-- EDITING LINK -->
                                    <!--<li>-->
                                        <a href="#" class="btn btn-info btn-primary btn-sm" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_class/<?php echo $row['class_id'];?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <!--<li>-->
                                        <a href="#" class="btn btn-danger btn-primary btn-sm" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/classes/delete/<?php echo $row['class_id'];?>');">
