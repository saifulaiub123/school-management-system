...
//		return $query->result_array();
	...
	function get_students($class_id,$dep_id='',$sec_id='')
	{
		$query	=	$this->db->get_where('student' , array('class_id' => $class_id,'dep_id' => $dep_id,'sec_id' => $sec_id));
		return $query->result_array();
	}
...
//      ////////////////Section///////////////
        ...
        function get_sec_name($sec_id)
	{
		$query	=	$this->db->get_where('section' , array('sec_id' => $sec_id));
		$res	=	$query->result_array();
		foreach($res as $row)
                return $row['sec_name'];
	}
