...
class Parents extends CI_Controller
{
    ...
    /***default functin, redirects to login page if no parent logged in yet***/
...
//                 $page_data['students']=$this->db->get_where('student' , array('class_id'=>$class_id,'dep_id'=>$group_id,'sec_id'=>$sec_id))->result_array();
        ...
        function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?parent/student_add/' . $data['class_id'], 'refresh');
        }
        if ($param2 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
...
//            $data['class_id']    = $this->input->post('class_id');
            ...
            redirect(base_url() . 'index.php?parent/student_information/' , 'refresh');
        } 
    ...
    function get_student_list($class_id='',$group_id='',$sec_id='')
    {
        ...
        $page_data['students'] = $this->db->get_where('student' , array('class_id'=>$class_id,'dep_id'=>$group_id,"sec_id"=>$sec_id))->result_array();
         ...
         $this->load->view('backend/parent/get_student_list', $page_data);
//        echo "yes";
    }
        ...
        if ($param1 == 'create') {
            ...
            $this->email_model->account_opening_email('parent', $data['email']); //SEND EMAIL ACCOUNT OPENING EMAIL
			 ...
			 $class_id	=	$this->db->get_where('student', array('student_id'=>$data['student_id']))->row()->class_id;
                         ...
                         $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/parent/' . $class_id , 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        			= $this->input->post('name');
            $data['email']       			= $this->input->post('email');
            ...
            redirect(base_url() . 'index.php?parent/parent/' . $param3, 'refresh');
        } else if ($param1 == 'edit') {
            $page_data['edit_data'] = $this->db->get_where('parent', array(
                'parent_id' => $param3
            ))->result_array();
...
//                                                  get_phrase('section')." : ".
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?parent/teacher/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['birthday']    = $this->input->post('birthday');
    ...
    function staff($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?parent/staff/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['birthday']   = $this->input->post('birthday');
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/subject/'.$data['class_id'], 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']       = $this->input->post('name');
            $data['class_id']   = $this->input->post('class_id');
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('deleted'));
            redirect(base_url() . 'index.php?parent/subject/'.$param3, 'refresh');
        }
        $page_data['class_id']   = $param1;
...
//            $data['teacher_id']   = $this->input->post('teacher_id');
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/classes/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
            $data['name_numeric'] = $this->input->post('name_numeric');
//            $data['teacher_id']   = $this->input->post('teacher_id');
    ...
    function section($param1 = '',$param2='',$param3='')
    {
        ...
        if($param1=='add')
        {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/add_section/' . $data['class_id'], 'refresh');
        }
        if($param1 == 'edit')
        {
            $class_id=$param3;
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('updated'));
            redirect(base_url() . 'index.php?parent/section_information/' . $class_id, 'refresh');
        }
        if ($param1 == 'delete') {
            $class_id=$param3;
            $this->db->where('sec_id', $param2);
    ...
    function get_sec_name($param1='',$param2='')
    {
        ...
        $data['dep_id']=$param2;
        $data1=  $this->load->view("backend/parent/get_sec_name",$data);
        echo $data1;
    }
...
//        echo $data['class_id'].' '.$data['dep_id'].' '.$data['sec_id'];
        $data1=  $this->load->view("backend/parent/get_sub_name",$data);
//        echo $data['class_id'];
    }
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/exam/', 'refresh');
        }
    ...
    function marks($exam_id = '', $class_id = '', $dep_id = '', $sec_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?parent/marks/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['dep_id'] . '/' . $page_data['sec_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?parent/marks/', 'refresh');
            }
        }
...
//                        $attendance_status  =   $this->input->post('status_' . $row['student_id']);
            ...
            $this->session->set_flashdata('flash_message', get_phrase('updated'));
			 ...
			 redirect(base_url() . 'index.php?parent/marks/' . $this->input->post('exam_id') . '/'. $this->input->post('class_id') . '/'. $this->input->post('dep_id') . '/' . $this->input->post('sec_id') . '/' . $this->input->post('subject_id'), 'refresh');
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/grade/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['grade_point'] = $this->input->post('grade_point');
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
        redirect(base_url() . 'index.php?parent/add_cl', 'refresh');
//            $this->get_routine_info();
        ...
        if ($param1 == 'do_update') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('updated'));
            redirect(base_url() . 'index.php?parent/class_routine/', 'refresh');
        } else if ($param1 == 'edit') {
...
//        $page_data['page_title'] = get_phrase('manage_class_routine');
	...
	function manage_attendance($class_id='',$group_id='',$sec_id)
	{
                ...
                if($_POST['save_attendence'])
		{
			...
			//redirect(base_url() . 'index.php?parent/manage_attendance/'.$date.'/'.$month.'/'.$year.'/'.$class_id .'/'.$group_id.'/'.$sec_id, 'refresh');
	...
	{
		redirect(base_url() . 'index.php?parent/manage_attendance/'.$this->input->post('class_id').'/'.$this->input->post('dep_id').'/'.$this->input->post('sec_id') , 'refresh');
	}
...
//            $data2['timestamp']         =   strtotime($this->input->post('date'));
            ...
            redirect(base_url() . 'index.php?parent/invoice', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['student_id']         = $this->input->post('student_id');
            $data['title']              = $this->input->post('title');
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/book', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']        = $this->input->post('name');
            $data['description'] = $this->input->post('description');
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/transport', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['route_name']        = $this->input->post('route_name');
            $data['number_of_vehicle'] = $this->input->post('number_of_vehicle');
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/dormitory', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']           = $this->input->post('name');
            $data['number_of_room'] = $this->input->post('number_of_room');
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('successfully_added'));
            redirect(base_url() . 'index.php?parent/noticeboard/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['notice_title']     = $this->input->post('notice_title');
            $data['notice']           = $this->input->post('notice');
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'send_new') {
            ...
            redirect(base_url() . 'index.php?parent/message/message_read/' . $message_thread_code, 'refresh');
        }

        if ($param1 == 'send_reply') {
            $this->crud_model->send_reply_message($param2);  //$param2 = message_thread_code
            $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
            redirect(base_url() . 'index.php?parent/message/message_read/' . $param2, 'refresh');
        }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'do_update') {
            ...
            redirect(base_url() . 'index.php?parent/system_settings/', 'refresh');
        }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
		...
		if ($param1 == 'update_phrase') {
			...
			redirect(base_url() . 'index.php?parent/manage_language/edit_phrase/'.$language, 'refresh');
		}
		if ($param1 == 'do_update') {
			...
			$this->session->set_flashdata('flash_message', get_phrase('settings_updated'));
			redirect(base_url() . 'index.php?parent/manage_language/', 'refresh');
		}
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        if ($operation == 'restore') {
            ...
            redirect(base_url() . 'index.php?parent/backup_restore/', 'refresh');
        }
        if ($operation == 'delete') {
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $this->session->set_flashdata('class_type', 'alert alert-info');
            $this->session->set_flashdata('flash_message', get_phrase('updated'));
            redirect(base_url() . 'index.php?parent/manage_profile/', 'refresh');
        }
        if ($param1 == 'change_password') {
            $data['password']             = $this->input->post('password');
            $data['new_password']         = $this->input->post('new_password');
...
//          $file_name="adfaf";
          //echo 'uploads/doc/'.$acc_type.'/'.$file_name.'';
            ...
            redirect(base_url() . 'index.php?parent/navigation/modal_document_upload/'.$data['user_id'].'/'.$data['role'], 'refresh');
         }
         if ($action == 'delete') {
            ...
            // echo $doc_id.' '.$user_id.' '.$role;
             ...
             redirect(base_url() . 'index.php?parent/navigation/modal_document_upload/'.$user_id.'/'.$role, 'refresh');
         }
